...
/**
 * @Description 将员工相关信息放到redis，默认1天过期
 * @Author wangjie36@gome.com.cn
 * @Date 2017/8/17
 * @Copyright(c) gome inc Gome Co.,LTD
 */
@Component
public class CacheEmployeeUtil {
    private static final Logger logger = LoggerFactory.getLogger(CacheEmployeeUtil.class);
    ...
    public boolean put(String key, Employee value) {
